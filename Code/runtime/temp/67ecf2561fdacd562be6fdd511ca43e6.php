<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"E:\study\php\18\Code\public/../application/index\view\index\index.html";i:1584586596;}*/ ?>
﻿<!DOCTYPE html>
<html lang="en-US">
                        ...
                        <div id="eskimo-sidebar-cell" class="w-100">
                            ...
                            <nav id="eskimo-main-menu" class="menu-main-menu-container">
                                <ul class="eskimo-menu-ul">
                                    ...
                                    <li><a href="/index/Index/toMine">我的</a></li>
                                </ul>
                            </nav>
                        </div>
                        <!-- SOCIAL MEDIA ICONS -->
        ...
        <aside id="eskimo-panel" class="eskimo-panel">
            <div class="eskimo-panel-inner">
                ...
                <div class="eskimo-author-box eskimo-widget">
                    ...
                    <h3><span>无心人</span></h3>
                    <p class="eskimo-author-description">questions!</p>
                ...
                <div class="eskimo-recent-entries eskimo-widget">
                    <h5 class="eskimo-title-with-border"><a href="blog-3-column.html">个人豆蔻</a></h5>
                    <ul>
                        <li>
                ...
                <!-- LOVE POSTS -->
                <div class="eskimo-recent-entries eskimo-widget">
                    <h5 class="eskimo-title-with-border"><a href="blog-3-column.html">收藏豆蔻</a></h5>
                    <ul>
                        <li>
                            <a href="single-post.html">Ketchup Flavored Ice Cream!</a>
                            <span class="post-date">May 28, 2018</span>
